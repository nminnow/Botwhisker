    ...
    for x in xs:
        ...
        for y in ys:
            ...
            for z in zs:
                ...
                if 'P95' in item.claims: continue # 出生于时间线
                byear = year
                bseason = season
                while True:
                    try:
                        ...
                        break
                claim = pywikibot.Claim(repo, 'P95')
                ...
                print(moon)
                item.claims['P95'][0].addQualifier(qualifier)
